...
def get_vectorstore(text_chunks):
    ...
    #embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")  # opsi gratis, kualitas lebih rendah
...
def load_vectorstore(path_to_vectorstore):
    ...
    embeddings = OpenAIEmbeddings()
    #embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")  # opsi gratis, kualitas lebih rendah
    vectorstore = FAISS.load_local(path_to_vectorstore, embeddings, allow_dangerous_deserialization=True)
    return vectorstore
